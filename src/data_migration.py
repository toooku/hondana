...
class DataMigration:
    ...
    @staticmethod
    def migrate_books_v1_to_v2(v1_books_data: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    def migrate_from_v1(
        ...
        try:
            ...
            DataMigration.migrate_impressions_to_markdown(v1_impressions, markdown_service)
