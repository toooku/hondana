...
class MarkdownImpressionService:
    ...
    def create_impression(self, book_id: str, content: str, book_title: str = "") -> Impression:
    ...
    def impression_exists(self, book_id: str, book_title: str = "") -> bool:
        ...
        return (book_title and os.path.exists(file_path_with_title)) or os.path.exists(file_path_old)
